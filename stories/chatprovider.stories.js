...
const ChatProviderDemo = () => (
  <div>
    ...
    <div className="demo-info-container">
      <p>
Example of default Chat Component.
      </p>
      <p>
View implementation details on
        <a href="https://github.com/Codebrahma/React-Chat/tree/master/">
Github
        </a>
      </p>
    </div>
...
storiesOf('Basic Usage', module)
  .add('ChatProvider Default', () => <ChatProviderDemo />);
